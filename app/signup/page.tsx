...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // 🚧 Placeholder: backend integration will go here later
    if (name && email && password) {
      router.push("/login"); // Temporary redirect after "signup"
    } else {
        ...
        <Card className="w-full md:w-5/12 max-w-2xl p-8 md:p-10 rounded-3xl shadow-2xl border border-primary/10 bg-card/90 backdrop-blur-lg mt-20">
          <div className="mb-6 text-center">
            ...
            <p className="text-base text-muted-foreground font-medium">
              Create your account to start your journey with Solvia.
            </p>
          </div>
